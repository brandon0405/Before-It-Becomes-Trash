...
const HOME_COPY: Record<AppLanguage, HomeCopy> = {
  ...
  es: {
    eyebrow: "Desafio del Dia de la Tierra",
    title: "Before It Becomes Trash",
    description:
      "Plataforma para decidir que hacer con objetos danados antes de tirarlos: analizar con IA, guardar rescates, ganar badges ecologicos y dejar constancias simbolicas en Solana Devnet.",
    login: "Iniciar sesion con Auth0",
    dashboard: "Ver dashboard",
    demo: "Continuar con demo",
    card1Title: "Asistente ecologico",
    card1Body: "Gemini genera diagnostico y recomendacion estructurada.",
    ...
    card4Body: "Respaldo SQLite en desarrollo para degradacion razonable.",
  },
  hi: {
    eyebrow: "Earth Day Challenge",
    title: "Before It Becomes Trash",
