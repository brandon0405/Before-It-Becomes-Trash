...
const DEMO_TEXT: Record<AppLanguage, DemoText> = {
  ...
  es: {
    probableDiagnosis: (itemName) => `Se detecta desgaste localizado en ${itemName}; las costuras o zonas de alta friccion probablemente fallan primero.`,
    repairJustification: "Reparar es practico con materiales de bajo costo y puede extender rapidamente la vida util evitando el descarte temprano.",
    repairSteps: [
      "Limpia y seca el area danada antes de intervenir.",
      "Refuerza costuras o zonas debiles con hilo resistente o parche textil adhesivo.",
      "Aplica una capa de proteccion para reducir friccion futura y verifica durabilidad en uso diario.",
    ],
    repairEcoImpact: "Una reparacion textil pequena evita residuos prematuros y reduce demanda de reemplazo.",
    ...
    electronicsJustification: "Una reparacion puntual puede recuperar funcionalidad con menor costo e impacto que reemplazar.",
    electronicsSteps: [
      "Haz una revision basica de seguridad y desconecta la energia antes de manipular.",
      "Inspecciona cable, conector y piezas moviles externas buscando desgaste o holgura.",
      "Reemplaza la pieza economica que falla o usa una guia de reparacion verificada y luego prueba en uso normal.",
    ],
    electronicsEcoImpact: "Reparar mantiene materiales mixtos en uso y reduce generacion de residuos electronicos.",
    electronicsRecoveredLife: "8-18 meses adicionales",
    genericDiagnosis: (itemName) => `${itemName} presenta degradacion parcial pero todavia conserva valor recuperable para uso circular.`,
    genericJustification: "La reutilizacion es rapida, segura y practica cuando no hace falta una reparacion completa.",
    genericSteps: [
      "Estabiliza cualquier zona danada y retira partes sueltas o filosas inseguras.",
      "Reutiliza el objeto para un uso secundario en el hogar segun su funcionalidad restante.",
      "Documenta el nuevo uso y monitorea su estado para retrasar el descarte final.",
    ],
    genericEcoImpact: "La reutilizacion extiende la vida del producto y retrasa su entrada al vertedero.",
